        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AzureAdUserId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientUsers_ClientId_AzureAdUserId",
                table: "ClientUsers",
                columns: new[] { "ClientId", "AzureAdUserId" },
                unique: true);
        }
